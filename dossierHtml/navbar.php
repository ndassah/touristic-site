...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <h4><a class=" navbar-bra " href="#">bookingTravel</a></h4>
      ...
      if(isset($_SESSION['auth']))
      {
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="profilUser">
            ...
            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-people-roof"></i> Ambassador program</a></li>
            <li><a class="dropdown-item" href="#"><i class="fa-solid fa-book-open-reader"></i> Terms of service</a></li>
